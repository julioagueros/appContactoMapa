# Django settings for appContactoMapa project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'appContactoMapa_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'pq(l3*4673vv-h&amp;m!htsml1pchgi#uff@&amp;!r&amp;f#hnkehal5r_e'
...
ROOT_URLCONF = 'appContactoMapa.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'appContactoMapa.wsgi.application'
